    ...
    <div className="footer">
        <div className="fLists">
            ...
            <ul className="fList">
                ...
                <li className="fListItem">AK Booking.com for Travel Agents</li>
            </ul>
            <ul className="fList">
                <li className="fListItem">Coronavirus COVID-19 FAQs</li>
                <li className="fListItem">About AK Booking.com</li>
        ...
        <div className="ftext">Copyright © 2022 AK Booking™. All rights reserved.</div>
    </div>
  )
}
